...
## Instrukcje instalacji oraz uruchomienia dla poszczegółnych systemów operacyjnych:

<!-- * [Instalacja na systemie Windows](docs/install-windows.md) -->
* [Instalacja na systemie macOS](docs/install-macos.md)
* [Instalacja na systemie Linux](docs/install-linux.md)